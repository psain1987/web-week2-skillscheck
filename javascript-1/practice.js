...
// Create a function called 'iLove' that takes in two string parameters, 'name' and 'love'. Have the function take the two parameters and return a 
...
me.greeter = () => 'Hello! My name is Phil and I live in Texas'
...
// Code Here
let total = myNumbers.reduce((acc, curr) => { return acc + curr})
