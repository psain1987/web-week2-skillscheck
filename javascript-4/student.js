...
// CODE HERE
let faveColors = ['Blue', 'Red', 'Yellow']
...
let me = {
    firstName: 'Phil',
    superHeroName: 'Flying Philicus',
    homeTown: 'St. Paul, MN',
    superPowers: ['Flying', 'Always Hungry', 'Unstoppable'],
...
// value assigned as the value of the superHeroName property on the me object. The last variable you should create is 'homeTown' which will be the value of homeTown on the me object
...
//////////////////Step 4////////////////////
//Create a function called 'setColor' that takes in one parameter called 'arr' that is an array of colors. Make sure that we only ever have three colors by using splice to trim 
//the array to just 3 colors. 
...
// which will take each item of the array as an argument. Remember, you did not create the createLi function. The createLi function is a function we created that determines how 
