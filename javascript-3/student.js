...
// Code Here
groceries = ['Bacon', 'Icecream', 'Candy'] 
...
//////////////////STEP 5////////////////////
// Create a function called 'removeItem' that takes in one parameter called 'index'. Inside of the removeItem function, remove the item that corresponds to the index parameter 
...
//////////////////STEP 6////////////////////
// Refresh the index.html page. You should now see the same thing you saw when you first loaded the page but you should now be able to add items to your grocery list 
// with a dynamic total showing. If you double click on an item, it should remove that item
